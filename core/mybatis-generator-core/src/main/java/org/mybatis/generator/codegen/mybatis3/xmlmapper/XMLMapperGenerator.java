...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectByIndexKeyElement(answer);
    ...
    protected void addSelectByIndexKeyElement(XmlElement parentElement) {
            AbstractXmlElementGenerator elementGenerator = new SelectByIndexKeyElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
