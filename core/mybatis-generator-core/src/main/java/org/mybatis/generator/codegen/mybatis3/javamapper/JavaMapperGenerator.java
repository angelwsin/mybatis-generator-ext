...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByIndexKeyMethod(interfaze);
    ...
    protected void addSelectByIndexKeyMethod(Interface interfaze) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByIndexKeyMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
