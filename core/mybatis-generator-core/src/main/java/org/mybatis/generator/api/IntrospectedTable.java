...
public abstract class IntrospectedTable {
    ...
    protected Map<String,List<IntrospectedColumn>> indexes;
    ...
    public void addIndexColumn(String indexName,String columnName) {
        boolean found = false;
        ...
        if(found){
            List<IntrospectedColumn> columns = indexes.get(indexName);
    ...
    public String getSelectByIndexKeyStatementId(String indexName) {
        List<IntrospectedColumn> it = indexes.get(indexName);
        StringBuilder builder = new StringBuilder("selectBy");
        builder.append(JavaBeansUtil.getFirstCharacterUppercase(it.get(0).getJavaProperty()));
        for(int i=1;i<it.size();i++){
            builder.append("And").append(JavaBeansUtil.getFirstCharacterUppercase(it.get(i).getJavaProperty()));
        }
    ...
    public Map<String,List<IntrospectedColumn>> getIndexes(){
          return indexes;
    }
}
